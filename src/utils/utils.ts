...
const isFirstLetterUppercase = (inputString: string) => {
...
const smallFirstLetter = (string: string) => {
    return string.charAt(0).toLowerCase() + string.slice(1);
};

export const replaceIdentifiers = (identifiers: Set<string>, text: string): string => {
    var textCopy = text;
